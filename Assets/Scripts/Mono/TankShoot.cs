...
{
    //gameobjects to hold the prefab that is copied, the cannonball that is instantiated and the spawn point for the cannonball
    public GameObject cannonball, prefabCannon;
    public Transform cannonSpawn, trans;
    CannonData data;
    ...
    {
        //create the copy of the prefab and spawn it at the spawn point
        ...
        //set the amount of damage of cannonball 
        ...
        //make the cannonball go forward by adding force to it's rigidbody component
        cannonball.GetComponent<Rigidbody>().AddForce(force * trans.forward);
        AudioSource.PlayClipAtPoint(GameManager.instance.shootClip, Vector3.zero, 50.0f);
